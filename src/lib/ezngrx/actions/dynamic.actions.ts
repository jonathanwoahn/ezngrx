...
import { DynamicActionResults, DynamicActionTypes } from "../ezngrx.models";
...
/**
 * SET ONE ENTITY ACTIONS
 */
export class SetOneEntity<T> extends DynamicAction {
  constructor(private entity: string, public payload: T) {
    super(entity, DynamicActionTypes.setOne);
  }
}

export class SetOneEntitySuccess<T> extends DynamicAction {
  constructor(private entity: string, public payload: T) {
    super(entity, DynamicActionTypes.setOne, DynamicActionResults.success);
  }
}

export class SetOneEntityFail<T> extends DynamicAction {
  constructor(private entity: string, public payload: HttpErrorResponse) {
    super(entity, DynamicActionTypes.setOne, DynamicActionResults.fail);
  }
}

/**
 * SET ALL ENTITIES ACTIONS
 */
export class SetAllEntities<T> extends DynamicAction {
  constructor(private entity: string, public payload: T[]) {
    super(entity, DynamicActionTypes.setAll);
  }
}

export class SetAllEntitiesSuccess<T> extends DynamicAction {
  constructor(private entity: string, public payload: T[]) {
    super(entity, DynamicActionTypes.setAll, DynamicActionResults.success);
  }
}

export class SetAllEntitiesFail<T> extends DynamicAction {
  constructor(private entity: string, public payload: HttpErrorResponse) {
    super(entity, DynamicActionTypes.setAll, DynamicActionResults.fail);
  }
}

/**
 * SET MANY ENTITIES ACTIONS
 */
export class SetManyEntities<T> extends DynamicAction {
  constructor(private entity: string, public payload: T[]) {
    super(entity, DynamicActionTypes.setMany);
  }
}

export class SetManyEntitiesSuccess<T> extends DynamicAction {
  constructor(private entity: string, public payload: T[]) {
    super(entity, DynamicActionTypes.setMany, DynamicActionResults.success);
  }
}

export class SetManyEntitiesFail<T> extends DynamicAction {
  constructor(private entity: string, public payload: HttpErrorResponse) {
    super(entity, DynamicActionTypes.setMany, DynamicActionResults.fail);
  }
}
...
export type DynamicActions<T> =
  ...
  // SET
  | SetOneEntity<T>
  | SetOneEntitySuccess<T>
  | SetOneEntityFail<T>
  | SetManyEntities<T>
  | SetManyEntitiesSuccess<T>
  | SetManyEntitiesFail<T>
  | SetAllEntities<T>
  | SetAllEntitiesSuccess<T>
  | SetAllEntitiesFail<T>
  // REMOVE
  | RemoveOneEntity<T>
