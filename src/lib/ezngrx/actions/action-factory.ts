...
export class ActionFactory<T> {
   ...
   * SET ONE
   */
  setOne(entity: T): DynamicActions<T> {
    return new SetOneEntity<T>(this.entity, entity);
  }

  setOneSuccess(entity: T): DynamicActions<T> {
    return new SetOneEntitySuccess<T>(this.entity, entity);
  }

  setOneFail(error: HttpErrorResponse): DynamicActions<T> {
   ...
   * SET ALL
   */
   setAll(entities: T[]): DynamicActions<T> {
    return new SetAllEntities<T>(this.entity, entities);
  }

  setAllSuccess(entities: T[]): DynamicActions<T> {
    return new SetAllEntitiesSuccess<T>(this.entity, entities);
  }

  setAllFail(error: HttpErrorResponse): DynamicActions<T> {
   ...
   * SET MANY
   */
   setMany(entities: T[]): DynamicActions<T> {
    return new SetManyEntities<T>(this.entity, entities);
  }

  setManySuccess(entities: T[]): DynamicActions<T> {
    return new SetManyEntitiesSuccess<T>(this.entity, entities);
  }

  setManyFail(error: HttpErrorResponse): DynamicActions<T> {
